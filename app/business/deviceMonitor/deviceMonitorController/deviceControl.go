...
func (d *DeviceControl) BroadcastControl(context.Context, *controlService.ControlRequest) (*controlService.ControlResponse, error) {
	return &controlService.ControlResponse{}, nil
}
