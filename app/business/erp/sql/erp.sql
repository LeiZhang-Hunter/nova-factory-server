...
CREATE TABLE IF NOT EXISTS `erp_order` (
    ...
    `receivername` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '收货人名称',
    `receiverstate` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '收货省',
    `receiverstate_name` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '收货省名称',
    `receivercity` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '收货市',
    `receivercity_name` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '收货市名称',
    `receiverdistrict` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '收货区',
    `receiverdistrict_name` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '收货区名称',
    `receiverstree` VARCHAR(50) NOT NULL COMMENT '收货街道',
    `receiverstree_name` VARCHAR(50) NOT NULL COMMENT '收货街道名称',
