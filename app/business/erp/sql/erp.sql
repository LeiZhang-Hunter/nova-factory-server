...
CREATE TABLE IF NOT EXISTS `erp_product` (
    ...
    `bar_code` varchar(64) NULL COMMENT '产品条码，对接 erp_order_detail.barcode',
    `category_id` bigint NULL DEFAULT 0 COMMENT '产品分类编号',
    `unit_id` bigint NULL DEFAULT 0 COMMENT '单位编号，关联 erp_product_unit.id，可与 erp_order_detail.unit_id 对齐',
    `status` tinyint(1) NULL DEFAULT 0 COMMENT '产品状态',
    `standard` varchar(255) NULL COMMENT '产品规格',
