...
func (s *StockRecordServiceImpl) create(c *gin.Context, req *stockmodels.StockRecordUpsert) (*stockmodels.StockRecord, error) {
	if req == nil {
...
func (s *StockRecordServiceImpl) update(c *gin.Context, req *stockmodels.StockRecordUpsert) (*stockmodels.StockRecord, error) {
	if req == nil {
		return nil, errors.New("参数不能为空")
	}
...
func (s *StockRecordServiceImpl) DeleteByIDs(c *gin.Context, ids []int64) error {
	if len(ids) == 0 {
...
func (s *StockRecordServiceImpl) GetByID(c *gin.Context, id int64) (*stockmodels.StockRecord, error) {
	if id <= 0 {
		return nil, errors.New("id不能为空")
	}
...
func (s *StockRecordServiceImpl) validateUniqueFields(c *gin.Context, req *stockmodels.StockRecordUpsert, currentID int64) error {
