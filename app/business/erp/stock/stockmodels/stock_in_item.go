...
// StockInItemUpsert ERP 其它入库单项新增修改参数
type StockInItemUpsert struct {
...
// StockInItemQuery ERP 其它入库单项查询参数
type StockInItemQuery struct {
...
// StockInItemListData ERP 其它入库单项分页数据
type StockInItemListData struct {
	Rows  []*StockInItem `json:"rows"`
