...
// StockOutItemUpsert ERP 其它出库单项新增修改参数
type StockOutItemUpsert struct {
...
// StockOutItemQuery ERP 其它出库单项查询参数
type StockOutItemQuery struct {
...
// StockOutItemListData ERP 其它出库单项分页数据
type StockOutItemListData struct {
	Rows  []*StockOutItem `json:"rows"`
