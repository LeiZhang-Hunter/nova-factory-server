...
// PurchaseInItem ERP 采购入库项
type PurchaseInItem struct {
	ID            int64   `json:"id,string" gorm:"column:id"`
	InID          int64   `json:"inId" gorm:"column:in_id"`
...
// PurchaseInItemUpsert ERP 采购入库项新增修改参数
type PurchaseInItemUpsert struct {
...
// PurchaseInItemQuery ERP 采购入库项查询参数
type PurchaseInItemQuery struct {
	WarehouseID int64 `form:"warehouseId" filter:"eq,warehouse_id"`
	ProductID   int64 `form:"productId" filter:"eq,product_id"`
	InID        int64 `form:"inId" filter:"eq,in_id"`
	Page        int64 `form:"page"`
	Size        int64 `form:"size"`
}

// PurchaseInItemListData ERP 采购入库项分页数据
type PurchaseInItemListData struct {
	Rows  []*PurchaseInItem `json:"rows"`
