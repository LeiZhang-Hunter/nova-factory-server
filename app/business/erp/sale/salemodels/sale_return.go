...
// SaleReturnUpsert ERP 销售退货新增修改参数
type SaleReturnUpsert struct {
	ID                int64   `json:"id,string"`
	No                string  `json:"no" binding:"required" label:"销售退货单号"`
...
// SaleReturnQuery ERP 销售退货查询参数
type SaleReturnQuery struct {
...
// SaleReturnListData ERP 销售退货分页数据
type SaleReturnListData struct {
	Rows  []*SaleReturn `json:"rows"`
