...
// SaleReturnItemUpsert ERP 销售退货项新增修改参数
type SaleReturnItemUpsert struct {
...
// SaleReturnItemQuery ERP 销售退货项查询参数
...
// SaleReturnItemListData ERP 销售退货项分页数据
type SaleReturnItemListData struct {
	Rows  []*SaleReturnItem `json:"rows"`
