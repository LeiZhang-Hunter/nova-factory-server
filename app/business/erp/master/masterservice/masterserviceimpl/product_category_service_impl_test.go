...
func (d *productCategoryServiceTestDAO) ListPage(c *gin.Context, req *mastermodels.ProductCategoryQuery) (*erpcrud.PageResult[mastermodels.ProductCategory], error) {
	return &erpcrud.PageResult[mastermodels.ProductCategory]{}, nil
}
