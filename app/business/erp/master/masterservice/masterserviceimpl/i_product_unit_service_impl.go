...
func (s *ProductUnitServiceImpl) create(c *gin.Context, req *mastermodels.ProductUnitUpsert) (*mastermodels.ProductUnit, error) {
	if req == nil {
...
func (s *ProductUnitServiceImpl) update(c *gin.Context, req *mastermodels.ProductUnitUpsert) (*mastermodels.ProductUnit, error) {
	if req == nil {
		return nil, errors.New("参数不能为空")
	}
...
func (s *ProductUnitServiceImpl) DeleteByIDs(c *gin.Context, ids []int64) error {
	if len(ids) == 0 {
...
func (s *ProductUnitServiceImpl) GetByID(c *gin.Context, id int64) (*mastermodels.ProductUnit, error) {
	if id <= 0 {
		return nil, errors.New("id不能为空")
	}
...
func (s *ProductUnitServiceImpl) validateUniqueFields(c *gin.Context, req *mastermodels.ProductUnitUpsert, currentID int64) error {
