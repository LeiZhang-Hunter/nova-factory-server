...
// SupplierUpsert ERP 供应商新增修改参数
type SupplierUpsert struct {
	ID          int64   `json:"id,string"`
	Name        string  `json:"name" binding:"required" label:"供应商名称"`
	Code        string  `json:"code" binding:"required" label:"供应商编码"`
