...
type SysIotAgent struct {
	...
	ObjectID          int64     `gorm:"column:object_id;not null;comment:agent uuid" json:"object_id"`                             // agent uuid
	CompanyUUID       string    `gorm:"column:company_uuid;not null;comment:公司uuid" json:"company_uuid"`                           // 公司uuid
	...
	OperateTime       time.Time `gorm:"column:operate_time;comment:操作时间" json:"operate_time"`                                      // 操作时间
