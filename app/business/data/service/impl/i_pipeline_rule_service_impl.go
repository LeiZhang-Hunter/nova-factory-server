...
type IPipelineRuleServiceImpl struct {
	rules       dao.IPipelineRuleDAO
	connections dao.IServiceConnectionDAO
}

type IServiceConnectionServiceImpl struct {
	connections dao.IServiceConnectionDAO
	rules       dao.IPipelineRuleDAO
	key         []byte
}

func NewIPipelineRuleServiceImpl(rules dao.IPipelineRuleDAO, connections dao.IServiceConnectionDAO) service.IPipelineRuleService {
	return &IPipelineRuleServiceImpl{rules: rules, connections: connections}
}

func NewIServiceConnectionServiceImpl(connections dao.IServiceConnectionDAO, rules dao.IPipelineRuleDAO) service.IServiceConnectionService {
	...
	return &IServiceConnectionServiceImpl{connections: connections, rules: rules, key: key}
}

func (s *IPipelineRuleServiceImpl) Create(c *gin.Context, req *dto.CreatePipelineRuleRequest) (*dto.PipelineRuleResponse, error) {
...
func (s *IPipelineRuleServiceImpl) Get(c *gin.Context, id string) (*dto.PipelineRuleResponse, error) {
...
func (s *IPipelineRuleServiceImpl) List(c *gin.Context, offset, limit int, sourceType, name, status string) ([]dto.PipelineRuleResponse, int64, error) {
...
func (s *IPipelineRuleServiceImpl) Update(c *gin.Context, id string, req *dto.UpdatePipelineRuleRequest) (*dto.PipelineRuleResponse, error) {
	rule, err := s.rules.GetByID(c, id)
	if err != nil {
		return nil, err
	}
...
func (s *IPipelineRuleServiceImpl) Delete(c *gin.Context, id string) error {
	rule, err := s.rules.GetByID(c, id)
	if err != nil {
		return err
	}
...
func (s *IPipelineRuleServiceImpl) ValidateConfig(c *gin.Context, raw json.RawMessage, sourceType string) (json.RawMessage, error) {
...
func (s *IPipelineRuleServiceImpl) ensureUnique(c *gin.Context, sourceType, name, exceptID string) error {
...
func (s *IPipelineRuleServiceImpl) validateReferences(c *gin.Context, sourceType string, refs []string) error {
...
func (s *IServiceConnectionServiceImpl) Create(c *gin.Context, req *dto.CreateServiceConnectionRequest) (*dto.ServiceConnectionResponse, error) {
	if err := s.ensureUnique(c, req.SourceType, req.Name, ""); err != nil {
		return nil, err
	}
...
func (s *IServiceConnectionServiceImpl) Get(c *gin.Context, id string) (*dto.ServiceConnectionResponse, error) {
...
func (s *IServiceConnectionServiceImpl) List(c *gin.Context, offset, limit int, sourceType, name, status string) ([]dto.ServiceConnectionResponse, int64, error) {
...
func (s *IServiceConnectionServiceImpl) Update(c *gin.Context, id string, req *dto.UpdateServiceConnectionRequest) (*dto.ServiceConnectionResponse, error) {
	row, err := s.connections.GetByID(c, id)
	if err != nil {
		return nil, err
	}
...
func (s *IServiceConnectionServiceImpl) Delete(c *gin.Context, id string) error {
	row, err := s.connections.GetByID(c, id)
	if err != nil {
		return err
	}
...
func (s *IServiceConnectionServiceImpl) ensureUnique(c *gin.Context, sourceType, name, exceptID string) error {
...
func (s *IServiceConnectionServiceImpl) encryptCredentials(credentials map[string]string) (string, error) {
	...
	return aes.EncryptString(s.key, cast.ToString(payload))
}

func (s *IServiceConnectionServiceImpl) credentialFields(encrypted string) []string {
...
func (s *IServiceConnectionServiceImpl) connectionResponse(row *entity.ServiceConnection) *dto.ServiceConnectionResponse {
