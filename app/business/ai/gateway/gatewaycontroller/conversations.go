...
func (conversations *Conversations) PrivateRoutes(router *gin.RouterGroup) {
	...
	group.GET("/list", middlewares.HasPermission("ai:agent:conversations:list"), conversations.ListConversations)
	group.POST("/create", middlewares.HasPermission("ai:agent:conversations:create"), conversations.CreateConversation)
