...
type UserService struct {
	...
	postDao     systemDao2.IPostDao
	deptDao     systemDao2.IDeptDao
	uds         systemDao2.IUserDeptScopeDao
	cs          systemService2.IConfigService
	of          objectFile.ObjectFile
}

func NewUserService(ms sqly.SqlyContext, ud systemDao2.IUserDao, upd systemDao2.IUserPostDao, urd systemDao2.IUserRoleDao, of objectFile.ObjectFile,
	dd systemDao2.IDeptDao, rd systemDao2.IRoleDao, pd systemDao2.IPostDao, uds systemDao2.IUserDeptScopeDao, cs systemService2.IConfigService) systemService2.IUserService {
	return &UserService{
		ms:          ms,
		userDao:     ud,
		userPostDao: upd,
...
func (userService *UserService) DeleteUserByIds(c *gin.Context, ids []int64) {
	...
	systemDaoImpl2.NewSysUserPostDao(tx).DeleteUserPost(c, ids)
	systemDaoImpl2.NewSysUserRoleDao(tx).DeleteUserRole(c, ids)
	systemDaoImpl2.NewSysUserDao(tx).DeleteUserByIds(c, ids)
...
func (userService *UserService) UpdateUserDataScope(c *gin.Context, uds *systemModels2.SysUserDataScope) {
	...
	udsd := systemDaoImpl2.NewSysUserDeptScopeDao(tx)
