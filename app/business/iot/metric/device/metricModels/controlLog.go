...
type NovaControlLog struct {
	...
	DeviceName    string            `json:"device_name"       gorm:"-"      description:"设备名字"`                     //
	DataId        uint64            `json:"data_id,string" gorm:"column:data_id"`
	DataName      string            `json:"data_name" gorm:"-"`
...
type NovaControlLogList struct {
	Rows  []*NovaControlLog `json:"rows"`
