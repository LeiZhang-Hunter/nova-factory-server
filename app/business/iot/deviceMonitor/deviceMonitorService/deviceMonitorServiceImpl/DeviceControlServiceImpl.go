...
type DeviceControlServiceImpl struct {
	...
	deviceConfigDao deviceDao2.ISysModbusDeviceConfigDataDao
}

func NewDeviceControlServiceImpl(agentDao daemonizeDao.IotAgentDao, cache cache.Cache,
	controlLogDao metricDao.IControlLogDao,
	dao deviceDao2.IDeviceDao,
	deviceConfigDao deviceDao2.ISysModbusDeviceConfigDataDao) deviceMonitorService.DeviceControlService {
