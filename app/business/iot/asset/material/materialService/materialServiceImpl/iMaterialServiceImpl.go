...
func (m *MaterialService) InsertMaterial(c *gin.Context, value *materialModels2.MaterialInfo) (*materialModels2.MaterialVO, error) {
...
func (m *MaterialService) UpdateMaterial(c *gin.Context, value *materialModels2.MaterialInfo) (*materialModels2.MaterialVO, error) {
...
func (m *MaterialService) SelectMaterialList(c *gin.Context, req *materialModels2.MaterialListReq) (*materialModels2.MaterialInfoListValue, error) {
	list, err := m.iMaterialDao.SelectMaterialList(c, req)
	if err != nil {
		zap.L().Error("读取列表衰退", zap.Error(err))
		return &materialModels2.MaterialInfoListValue{
			Rows:  make([]*materialModels2.MaterialValue, 0),
			Total: 0,
		}, err
	}
	...
	ret := make([]*materialModels2.MaterialValue, 0)
	for _, v := range list.Rows {
		...
		value := &materialModels2.MaterialValue{
...
func (m *MaterialService) GetByMaterialId(c *gin.Context, id int64) (*materialModels2.MaterialVO, error) {
	return m.iMaterialDao.GetByMaterialId(c, id)
}

func (m *MaterialService) Inbound(c *gin.Context, info *materialModels2.InboundInfo) (*materialModels2.InboundVO, error) {
	return m.iMaterialDao.Inbound(c, info)
}
func (m *MaterialService) Outbound(c *gin.Context, info *materialModels2.OutboundInfo) (*materialModels2.OutboundVO, error) {
	return m.iMaterialDao.Outbound(c, info)
}

func (m *MaterialService) InboundList(c *gin.Context, req *materialModels2.InboundListReq) (*materialModels2.InboundListData, error) {
...
func (m *MaterialService) OutboundList(c *gin.Context, req *materialModels2.OutboundListReq) (*materialModels2.OutboundListData, error) {
