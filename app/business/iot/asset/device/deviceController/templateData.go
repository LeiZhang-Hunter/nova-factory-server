...
type TemplateData struct {
	service         deviceService2.ISysModbusDeviceConfigDataService
	templateService deviceService2.IDeviceTemplateService
	deviceService   deviceService2.IDeviceService
}

func NewTemplateData(service deviceService2.ISysModbusDeviceConfigDataService,
	templateService deviceService2.IDeviceTemplateService,
	deviceService deviceService2.IDeviceService) *TemplateData {
	return &TemplateData{
		service:         service,
