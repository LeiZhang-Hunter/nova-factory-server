...
type SysDeviceSubject struct {
	ID              int64  `gorm:"column:id;primaryKey;autoIncrement:true;comment:项目ID" json:"id,string"` // 项目ID
...
type SysDeviceSubjectListData struct {
	Rows  []*SysDeviceSubject `json:"rows"`
