...
type IotAgent struct {
	service   daemonizeService2.IotAgentService
	daemonize daemonizeService2.DaemonizeService
}

func NewIotAgentController(service daemonizeService2.IotAgentService, daemonize daemonizeService2.DaemonizeService) *IotAgent {
	return &IotAgent{
		service:   service,
		daemonize: daemonize,
	}
