...
type IScheduleServiceImpl struct {
	scheduleDao    craftRouteDao2.IScheduleDao
	scheduleMapDao craftRouteDao2.IScheduleMapDao
	routeDao       craftRouteDao2.ICraftRouteDao
	routeConfigDao craftRouteDao2.ISysCraftRouteConfigDao
	db             *gorm.DB
}

func NewIScheduleServiceImpl(scheduleDao craftRouteDao2.IScheduleDao, db *gorm.DB,
	scheduleMapDao craftRouteDao2.IScheduleMapDao,
	routeDao craftRouteDao2.ICraftRouteDao,
	routeConfigDao craftRouteDao2.ISysCraftRouteConfigDao) craftrouteservice.IScheduleService {
...
func (i *IScheduleServiceImpl) formatSpecialRet(list []*craftRouteModels2.SysProductScheduleMap) map[int64]*craftRouteModels2.SysProductScheduleMap {
	var data map[int64]*craftRouteModels2.SysProductScheduleMap = make(map[int64]*craftRouteModels2.SysProductScheduleMap)
	for _, v := range list {
...
func (i *IScheduleServiceImpl) GetMonthSchedule(c *gin.Context, req *craftRouteModels2.SysProductScheduleReq) ([]*craftRouteModels2.ScheduleStatusData, error) {
	// 搜索普通日程
	scheduleList, err := i.scheduleDao.GetDailySchedule(c)
	if err != nil {
		zap.L().Error("get daily schedule", zap.Error(err))
		return make([]*craftRouteModels2.ScheduleStatusData, 0), err
	}
	...
	data := make([]*craftRouteModels2.ScheduleStatusData, 42)
	for k, v := range timeList {
		data[k] = &craftRouteModels2.ScheduleStatusData{}
		...
		if ok {
			data[k] = &craftRouteModels2.ScheduleStatusData{
				...
				Type: craftRouteModels2.SPECIAL,
			}
			continue
		}
		...
		data[k] = &craftRouteModels2.ScheduleStatusData{
			Time: systime.Unix(v, 0),
			Type: craftRouteModels2.DAILY,
		}
	}
	return data, nil
}

func (i *IScheduleServiceImpl) List(c *gin.Context, req *craftRouteModels2.SysProductScheduleListReq) (*craftRouteModels2.SysProductScheduleListData, error) {
	return i.scheduleDao.List(c, req)
}

func (i *IScheduleServiceImpl) Set(c *gin.Context, data *craftRouteModels2.SetSysProductSchedule) error {
	// 校验控制id
	...
	var err error
	var list []*craftRouteModels2.SysCraftRoute
	...
	// 保存调度主表
	var value *craftRouteModels2.SysProductSchedule
...
func (i *IScheduleServiceImpl) Detail(c *gin.Context, id int64) (*craftRouteModels2.DetailSysProductData, error) {
	scheduleInfo, err := i.scheduleDao.GetById(c, id)
	if err != nil {
		return &craftRouteModels2.DetailSysProductData{}, err
	}
	...
	return &craftRouteModels2.DetailSysProductData{
		Info: scheduleInfo,
		Data: scheduleMapList,
	}, nil
}

func (i *IScheduleServiceImpl) GetRouters(ctx *gin.Context, req *craftRouteModels2.ScheduleReq, gatewayInfo *daemonizemodels.SysIotAgent) ([]int64, error) {
	ids := make([]int64, 0)
	//查找特殊日程
...
// Schedule 任务调度
func (i *IScheduleServiceImpl) Schedule(ctx *gin.Context, req *craftRouteModels2.ScheduleReq, gatewayInfo *daemonizemodels.SysIotAgent) ([]*v1.Router, error) {
