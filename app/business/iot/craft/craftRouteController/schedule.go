...
func (schedule *Schedule) List(c *gin.Context) {
	req := new(craftRouteModels2.SysProductScheduleListReq)
...
func (schedule *Schedule) MonthList(c *gin.Context) {
	req := new(craftRouteModels2.SysProductScheduleReq)
	err := c.ShouldBindQuery(req)
	if err != nil {
		baizeContext.ParameterError(c)
		return
...
func (schedule *Schedule) Set(c *gin.Context) {
	data := new(craftRouteModels2.SetSysProductSchedule)
	...
	// 检查type
	if data.Type != craftRouteModels2.SPECIAL && data.Type != craftRouteModels2.DAILY {
...
func (schedule *Schedule) Detail(c *gin.Context) {
	req := new(craftRouteModels2.DetailSysProductSchedule)
	err := c.ShouldBindQuery(req)
	if err != nil {
		baizeContext.ParameterError(c)
		return
...
func (schedule *Schedule) Schedule(c *gin.Context) {
	req := new(craftRouteModels2.ScheduleReq)
