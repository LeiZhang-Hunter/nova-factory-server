...
(
    ...
    `user_id` bigint(20) NOT NULL COMMENT '用户ID，对应 shop_user.id',
    ...
    `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '订单状态：0待支付，1已支付，2已发货，3已完成，4已取消',
    ...
    `receiver_province` varchar(64) NULL DEFAULT NULL COMMENT '省份',
    `receiver_city` varchar(64) NULL DEFAULT NULL COMMENT '城市',
    `receiver_district` varchar(64) NULL DEFAULT NULL COMMENT '区县',
    `receiver_detail_address` varchar(512) NOT NULL COMMENT '详细地址',
    `remark` varchar(1024) NULL DEFAULT NULL COMMENT '订单备注',
...
(
    `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `order_id` bigint(20) NOT NULL COMMENT '订单ID，对应 shop_order.id',
    `order_no` varchar(64) NOT NULL COMMENT '订单号',
    `goods_id` varchar(64) NOT NULL COMMENT '商品ID，对应 shop_goods.goods_id',
    `sku_id` varchar(64) NOT NULL COMMENT 'SKU ID，对应 shop_goods_sku.sku_id',
    `goods_name` varchar(255) NOT NULL COMMENT '商品名称快照',
    `sku_name` varchar(255) NULL DEFAULT NULL COMMENT 'SKU名称快照',
    `image_url` varchar(1024) NULL DEFAULT NULL COMMENT '商品图片快照',
    `price` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT '商品单价快照',
    `quantity` int(11) NOT NULL DEFAULT 1 COMMENT '购买数量',
    `total_amount` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT '商品小计金额',
    `dept_id` bigint(20) NULL DEFAULT NULL COMMENT '部门ID',
    `create_by` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
    `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
    `update_by` bigint(20) NULL DEFAULT NULL COMMENT '更新者',
