CREATE TABLE IF NOT EXISTS `shop_category` (
  ...
  `parent_id` BIGINT(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '父分类ID，0表示根分类',
...
CREATE TABLE IF NOT EXISTS `shop_goods` (
  ...
  `home_module_ids` VARCHAR(2000) NOT NULL DEFAULT '' COMMENT '推荐首页模块ID集合，多个以逗号分隔',
    `dept_id` bigint(20) NULL DEFAULT NULL COMMENT '部门ID',
    `create_by` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
...
CREATE TABLE IF NOT EXISTS `shop_user_cart` (
    ...
    `product_type` TINYINT NOT NULL DEFAULT 0 COMMENT '商品类型：0普通，1秒杀，3拼团',
    `activity_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT '活动商品ID，普通商品为0',
    `pink_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT '拼团记录ID，非参团为0',
    ...
    `state` tinyint(1) NULL DEFAULT 0 COMMENT '操作状态（0正常 -1删除）',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uk_user_sku_activity` (`user_id`, `sku_id`, `product_type`, `activity_id`, `state`),
    KEY `idx_user_id` (`user_id`),
    KEY `idx_goods_id` (`goods_id`),
    KEY `idx_sku_id` (`sku_id`),
    KEY `idx_activity` (`product_type`, `activity_id`),
...
CREATE TABLE IF NOT EXISTS `shop_store_combination` (
    ...
    `cost` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '拼图商品成本',
    ...
    `quota` bigint(20) NOT NULL DEFAULT '0' COMMENT '限购总数',
    `quota_show` bigint(20) NOT NULL DEFAULT '0' COMMENT '限量总数显示',
...
CREATE TABLE IF NOT EXISTS `shop_store_pink` (
    ...
    `order_id_key` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '订单id  数据库',
    `total_num` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '购买商品个数',
    `total_price` decimal(12,2) UNSIGNED NOT NULL DEFAULT '0.00' COMMENT '购买总金额',
    `cid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '拼团商品id',
    `pid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '商品id',
    `people` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '拼图总人数',
...
CREATE TABLE IF NOT EXISTS `shop_store_seckill_activity` (
    ...
    `home_module_ids` varchar(2000) NOT NULL DEFAULT '' COMMENT '推荐首页模块ID集合，多个以逗号分隔',
    `add_time` bigint(10) NOT NULL DEFAULT '0' COMMENT '添加时间',
    `dept_id` bigint(20) NULL DEFAULT NULL COMMENT '部门ID',
    `create_by` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
    `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
    `update_by` bigint(20) NULL DEFAULT NULL COMMENT '更新者',
...
CREATE TABLE IF NOT EXISTS `shop_store_seckill` (
    `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品秒杀商品表id',
    ...
    `quota` bigint(20) NOT NULL DEFAULT '0' COMMENT '限购总数',
    `quota_show` bigint(20) NOT NULL DEFAULT '0' COMMENT '限购总数显示',
...
CREATE TABLE IF NOT EXISTS `shop_order` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE INDEX `uk_shop_order_tid` (`tid`) USING BTREE,
    INDEX `idx_shop_order_status` (`status`) USING BTREE,
    INDEX `idx_shop_order_sync_status` (`sync_status`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `shop_order_detail` (
    ...
    `shipped_qty` decimal(18,4) NOT NULL DEFAULT '0.0000' COMMENT '累计已发货数量',
    ...
    PRIMARY KEY (`id`),
    UNIQUE INDEX `uk_shop_order_detail_oid` (`oid`) USING BTREE,
    INDEX `idx_shop_order_detail_order_id` (`order_id`) USING BTREE,
    INDEX `idx_shop_order_detail_tid` (`tid`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `shop_order_account` (
    ...
    PRIMARY KEY (`id`),
    INDEX `idx_shop_order_account_order_id` (`order_id`) USING BTREE,
