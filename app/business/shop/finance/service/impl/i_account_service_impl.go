...
func NewAccountService(dao dao.IAccountDao) service.IAccountService {
...
func (s *AccountServiceImpl) create(c *gin.Context, req *models.AccountUpsert) (*models.Account, error) {
	if req == nil {
...
func (s *AccountServiceImpl) update(c *gin.Context, req *models.AccountUpsert) (*models.Account, error) {
	if req == nil {
		return nil, errors.New("参数不能为空")
	}
	...
	if req.DefaultStatus != nil && *req.DefaultStatus {
		if err := s.dao.ResetDefaultStatus(c, id); err != nil {
			return nil, err
		}
	}
...
func (s *AccountServiceImpl) GetByID(c *gin.Context, id int64) (*models.Account, error) {
	if id <= 0 {
		return nil, errors.New("id不能为空")
	}
...
func (s *AccountServiceImpl) ListPage(c *gin.Context, req *models.AccountQuery) (*models.AccountListData, error) {
	if req != nil {
		accountTrimStringFields(req)
	}
...
func (s *AccountServiceImpl) validateUniqueFields(c *gin.Context, req *models.AccountUpsert, currentID int64) error {
...
func (s *AccountServiceImpl) List(c *gin.Context, req *models.AccountQuery) (*models.AccountListData, error) {
