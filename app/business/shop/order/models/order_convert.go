...
func ToOrder(event event.OrderEvent) []*Order {
	...
	for _, eventOrder := range eventOrders {
		...
		order := &Order{
			...
			ReceiverProvinceName: eventOrder.GetReceiverStateName(),
			ReceiverCity:         eventOrder.GetReceiverCity(),
			ReceiverCityName:     eventOrder.GetReceiverCityName(),
			ReceiverDistrict:     eventOrder.GetReceiverDistrict(),
			ReceiverDistrictName: eventOrder.GetReceiverDistrictName(),
