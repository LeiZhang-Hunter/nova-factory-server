		...
		Orders: []*OrderSyncOrder{
			{
				...
				ReceiverState:        stringUtils.FirstNonEmpty(order.ReceiverProvince, order.ReceiverProvinceName),
				ReceiverStateName:    order.ReceiverProvinceName,
				ReceiverCity:         stringUtils.FirstNonEmpty(order.ReceiverCity, order.ReceiverCityName),
				ReceiverCityName:     order.ReceiverCityName,
				ReceiverDistrict:     stringUtils.FirstNonEmpty(order.ReceiverDistrict, order.ReceiverDistrictName),
