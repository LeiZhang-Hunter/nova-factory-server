...
type OrderRefund struct {
	...
	ReturnLogisticsCompany string     `gorm:"column:return_logistics_company;type:varchar(64);comment:退货物流公司" json:"return_logistics_company"` // 退货物流公司
	ReturnLogisticsCode    string     `gorm:"column:return_logistics_code;type:varchar(128);comment:退货物流单号" json:"return_logistics_code"`      // 退货物流单号
