...
const (
	DeviceReportService_ReportContainer_FullMethodName = "/app.pkg.metric.grpc.v1.DeviceReportService/ReportContainer"
)
...
var DeviceReportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "app.pkg.metric.grpc.v1.DeviceReportService",
