...
//go:generate go run -mod=mod github.com/google/wire/cmd/wire gen -tags "ai iot"
//go:build !wireinject
// +build !wireinject
...
func wireApp() (*gin.Engine, func(), error) {
	...
	shopShop := shop.NewGinEngine(app, cacheCache)
	settingcontrollerController := erp.NewController()
