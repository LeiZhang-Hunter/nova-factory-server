...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/erp/setting/logistics-company/list": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/erp/setting/logistics-company/set": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "ERP物流公司参数",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/settingmodels.LogisticsCompanyUpsert"
                        }
                    }
                ],
                "responses": {
        ...
        "/erp/setting/logistics-company/{ids}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/erp/setting/logistics-company/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/erp/setting/sale/agent-config/list": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/erp/setting/sale/agent-config/set": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "销售订单智能体配置参数",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/settingmodels.AgentConfigUpsert"
                        }
                    }
                ],
                "responses": {
        ...
        "/erp/setting/sale/agent-config/{ids}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/erp/setting/sale/agent-config/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "settingmodels.LogisticsCompanyUpsert": {
            "type": "object",
            "required": [
                "cityCode",
                "cityName",
